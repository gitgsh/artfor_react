...
function ProjectFundingPlan(props) {
  ...
  >
    ...
    >
    <div style={{paddingTop:"5%", paddingBottom:"5%", display:"inline-block"}}>
      <Row>
        <Col>
        ...
        <Col>
          <div className="fb">
            <a href="/project/main" style={{textDecorationLine:'none'}}>
              <div>
                <p style={{textAlign:"left"}}><img src='/safety.png' style={{width:"25px"}} /> </p>
                  <p className="pfpt">
                    신뢰와 안전
                  </p>
                  <p>28%작성완료</p>
        ...
        <Col>
          <div className="fb">
            <a href="/project/check" style={{textDecorationLine:'none'}}>
              <div>
                <p style={{textAlign:"left"}}><img src='/pen.png' style={{width:"25px"}} /> </p>
                <p className="pfpt">
                  기본 정보
                </p>
                <p>28%작성완료</p>
