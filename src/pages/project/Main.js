      ...
      <div className="pmain" style={{ fontFamily: "NanumSquareR" }}>
        ...
        <div class="p_m_miancontent" height="100%">
          ...
          <div class="p_m_c2">
            <div class="p_m_c2_1">
              <br />
              <h2 align="left" style={{ fontWeight: "bold" }}>
                쉽게 시작할 수 있습니다!
              </h2>
              <br />
              <p>
                ‘크라우드펀딩’은 어려울지 몰라도 artfor은 어렵지 않습니다.
            ...
            <div class="p_m_c3_1">
              <Card style={{ width: "22rem" }}>
                <Card.Body>
                  ...
                  <Card.Subtitle className="p_m_cardsub">
                    평소 몰두했던 작업이나 구상만 하던 창작 아이디어를 본격적인
                    단계로 발전시킬 기회로 삼아보세요.
                  </Card.Subtitle>
                  <Card.Text className="p_m_cardtext">
                    시작하는 창작자에게 artfor은 지원금, 공모전 등의 방식들보다
        ...
        <Jumbotron className="p_m_jumbo2">
          <h1 className="p_m_title" style={{ color: "black" }}>
            프로젝트를 만들어보세요!
          </h1>
