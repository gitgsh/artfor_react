      ...
      <div>
          <div className="pmain">
                <Jumbotron className="p_m_jumbo"> 
                    ...
                    <br />
                    <p className="p_m_p1">크라우드펀딩으로 프로젝트를 위한 자금도 모으고,
                ...
                <div class="p_m_miancontent" height="100%">
                    <div class="p_m_c1">
                        <div class="p_m_c1_1">
                        ...
                        <div class="p_m_c1_2">
                            <br />
                            <h1 style={{ fontWeight: "bold"}}>artfor에서 펀딩에 성공한<br />20,300개 프로젝트와 함께 하세요.</h1><br />
                            <p>디자인, 영화, 게임, 출판, 요리, 패션, 이벤트 …
                            분야를 가릴 것 없이 수많은 창작자와 창업자들의 프로젝트들이 매일같이 올라오는 artfor은 한국에서 가장 활성화된 크라우드펀딩 커뮤니티입니다. 
                    ...
                    <div class="p_m_c2">
                        ...
                        <CardGroup>
                            <Card className="p_m_card">
                                ...
                                <Card.Title className="p_m_cardtitle">프로젝트 올리기</Card.Title>
                                <Card.Text className="p_m_cardtext">
                            ...
                            <Card className="p_m_card">
                                ...
                                <Card.Title className="p_m_cardtitle">펀딩 진행하기</Card.Title>
                                <Card.Text className="p_m_cardtext">
                            ...
                            <Card className="p_m_card">
                                ...
                                <Card.Title className="p_m_cardtitle">만들고 보답하기</Card.Title>
                                <Card.Text className="p_m_cardtext">
                    ...
                    <div class="p_m_c3">
                        <br />
                        <br />
                        <h2 align="left" style={{ fontWeight: "bold"}}>누구에게나 열려 있습니다</h2>
                        <div class="p_m_c3_1">
                        <Card style={{ width: '22rem' }}>
                            <Card.Body>
                                <Card.Title className="p_m_cardtitle" >창작자</Card.Title>
                                <Card.Subtitle className="p_m_cardsub">평소 몰두했던 작업이나 구상만 하던 창작 아이디어를 본격적인 단계로 발전시킬 기회로 삼아보세요.</Card.Subtitle>
                                <Card.Text className="p_m_cardtext">
                                시작하는 창작자에게 artfor은 지원금, 공모전 등의 방식들보다 훨씬 자율적이고 독립적으로 나와 내 작업을 알릴 수 있는 새로운 길입니다. 
                                이미 콘텐츠와 팬층을 확보한 작가라면 신선한 기획을 통해 팬들을 만나는 새로운 창구를 열어보는 건 어떨까요?
                                </Card.Text>
                            </Card.Body>
                        </Card>
                        </div>
                        ...
                        <Card style={{ width: '22rem' }}>
                            <Card.Body>
                                ...
                                <Card.Subtitle className="p_m_cardsub">초기 비용이나 재고 부담 없이 새로운 제품이나 서비스를 론칭하고 코어 팬 베이스를 확보하세요.</Card.Subtitle>
                                <Card.Text className="p_m_cardtext">
                                브랜드에 이목을 집중시키는 스토리를 통해 마케팅 효과를 극대화할 수 있습니다. 
                                트렌디하면서도 개인의 취향과 가치가 강조되는 새로운 참여형 소비 창구로 각광받는 artfor에서 모인 후원자들의 신뢰는 일반 이커머스에서보다 훨씬 깊고 오래 가는 팬 베이스가 되어줄 것입니다
                                </Card.Text>
                            </Card.Body>
                        </Card>
                        </div>
                        ...
                        <Card style={{ width: '21rem' }}>
                            <Card.Body>
                                ...
                                <Card.Subtitle className="p_m_cardsub">임팩트 있는 캠페인을 통해 사회적 이슈를 지속가능한 참여와 후원으로 전환시켜보세요.</Card.Subtitle>
                                <Card.Text className="p_m_cardtext">
                                언론이나 소셜미디어에서 떠오르는 이슈들을 구체적인 행동으로 전환시키는 데에 artfor 프로젝트가 제격입니다. 
                                새롭고 젊은 정치참여·사회운동 방식으로 주목받는 artfor 펀딩으로 더 많은 지지자를 얻고, 사회적 목소리를 증폭시켜보세요.
                                </Card.Text >
