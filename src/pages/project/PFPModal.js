    ...
    return (
        ...
        <Modal size="lg" {...props} aria-labelledby="contained-modal-title-vcenter">
            <Modal.Header>
                ...
                <button className="clb" onClick={props.onHide}>x</button>
                {/* <button style={{float:"right", width:"15px", height:"15px"}} onClick={props.onHide} value="x"></button> */}
                {/* <Modal.Title>
                        ArtFor
                </Modal.Title> */}
            </Modal.Header>
        <Container style={{width:"100%", border:"none", marginTop:"2%", textAlign:"center"}}>
        <div style={{textAlign:"center", marginTop:"5%", marginBottom:"6%"}}>
            <p class="pmtitle" >artfor의 프로젝트 심사 기준을 확인해주세요.</p>
            <p class="pmsubTitle">심사 기준을 준수하면 보다 빠른 프로젝트 승인이 가능합니다.</p>
        </div>
        ...
        <Col>
            <div className="mm">
              <div className="mm2">
                ...
                <div className="mm3">
                <p style={{fontSize:"16px", fontWeight:"500"}}><strong>승인 가능 프로젝트</strong></p>
                <div>
                    <ul>
                        <li>기존에 없던 새로운 시도</li>
        ...
        <Col >
          <div className="mm">
              <div className="mm2">
                ...
                <div className="mm3">
                <p style={{fontSize:"16px", fontWeight:"500"}}><strong>반려 대상 프로젝트</strong></p>
                    <div>
                        <ul>
        ...
        <Button 
            className="pfpb"
            onClick={props.onHide}>확인</Button>
        </Container>
