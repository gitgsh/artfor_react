...
import { Button, Form, FormCheck, FormControl, InputGroup } from 'react-bootstrap';
            ...
            <div className="container_join" >
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="join-form-input-1">
                        ...
                        <InputGroup>
                        <FormControl className="login-form-input-row" type = "text" placeholder="사용하실 이름을 입력해주세요." {...register("user_name", {required:true, maxLength : 20, minLength : 2 })}/>
                        </InputGroup>
                    ...
                    <div className="join-form-input-1">
                        ...
                        <InputGroup>
                        <FormControl className="login-form-input-row" placeholder="이메일 주소를 입력해주세요." type="email" {...register("user_email", {required:true, pattern: /^\S+@\S+$/i}) } />
                    ...
                    <div className="join-form-input-1">
                        <InputGroup>
                        <FormControl className="login-form-input-row" placeholder="인증번호 6자리 입력" {...register("confirmNum", {required:true, pattern: /\d/}) } />
                    ...
                    <div className="join-form-input-1">
                        ...
                        <InputGroup>
                        <FormControl className="login-form-input-row" type="text" placeholder="비밀번호를 입력해주세요." {...register("user_pw", {required:true, maxLength : 20, minLength : 2 })} />
                        </InputGroup>
                    ...
                    <div className="join-form-input-1">
                        <InputGroup>
                        <FormControl className="login-form-input-row" placeholder="비밀번호를 확인합니다." {...register("user_pw_con", 
